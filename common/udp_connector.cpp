...
namespace FXNET
{
	...
	{
		this->m_oBuffContral.SetAckOutTime(5.);
		if (int dwError = this->m_oBuffContral.Init(dwState))
		{
	...
	{
		LOG(pOStream, ELOG_LEVEL_DEBUG2) << this->NativeSocket() << ", error: " << this->m_dwError
#ifndef _WIN32
